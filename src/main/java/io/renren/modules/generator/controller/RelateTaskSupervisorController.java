...
//    @RequiresPermissions("generator:relatetasksupervisor:list")
    ...
    @RequestMapping("/getListByuserId/{user_id}")
//    @RequiresPermissions("generator:relatetasksupervisor:info")
    public R res(@PathVariable("user_id") Integer user_id){
        List<RelateTaskSupervisorEntity>  relateTaskSupervisor = relateTaskSupervisorService.queryByUserId(user_id);
